...
(function(exports) {
  var FD, Font, FontListSWF, container, doneTestingFonts, dummy, fontAvailabilityChecker, fontListSWF, genericFontFamilies, loadFonts, someCommonFontNames, swfFonts, swfId, testFonts, testedFonts;
  ...
  fontAvailabilityChecker = (function() {
    var baseFontFamilies, baseHeights, baseWidths, span, testSize, testString;
    ...
    return {
      init: function() {
        var baseFontFamily, i, len, results;
        document.body.appendChild(container);
        results = [];
        for (i = 0, len = baseFontFamilies.length; i < len; i++) {
          baseFontFamily = baseFontFamilies[i];
      ...
      check: function(font) {
        var baseFontFamily, differs, i, len;
        for (i = 0, len = baseFontFamilies.length; i < len; i++) {
          baseFontFamily = baseFontFamilies[i];
  ...
  loadFonts = function() {
    ...
    fallback = function() {
      ...
      return testFonts((function() {
        var i, len, results;
        results = [];
        for (i = 0, len = someCommonFontNames.length; i < len; i++) {
          fontName = someCommonFontNames[i];
        ...
        return interval = every(50, function() {
          ...
          if (swf.fonts) {
            ...
            return testFonts((function() {
              ...
              results = [];
              for (i = 0, len = ref.length; i < len; i++) {
                ref1 = ref[i], fontName = ref1.fontName, fontType = ref1.fontType, fontStyle = ref1.fontStyle;
  ...
  testFonts = function(fonts) {
    var available, callback, font, i, j, k, len, len1, len2, ref, ref1;
  ...
  FD.each = function(callback) {
    var font, i, len;
    for (i = 0, len = testedFonts.length; i < len; i++) {
      font = testedFonts[i];
      callback(font);
    }
    if (!doneTestingFonts) {
