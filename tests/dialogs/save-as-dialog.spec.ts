...
import { openDialogFromMenu, closeDialog, setDialogTextInput, getDialogTitle } from "../utils/dialog-helpers";
...
test.describe("Save As Dialog", () => {
  ...
  test("should have filename input", async ({ page }) => {
    ...
    const filenameInput = dialog.locator('input[name*="filename"], input[name*="name"], input[type="text"]');
