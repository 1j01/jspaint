...
loaded_localizations("zh-simplified", {
	...
	"History":"历史记录",
	"&History":"历史记录(&H)",
	"&Render History As GIF":"将历史记录导出为GIF(&R)",
	"&Multi-User":"多人协作(&M)",
	"&New Session From Document":"从文档新建会话(&N)",
	"New &Blank Session":"新建空白会话(&B)",
	"&Themes":"主题(&T)",
	"&Classic":"经典(&C)",
	"&Dark":"黑暗(&D)",
	"&Modern":"现代(&M)",
	"&Winter":"冬季(&W)",
	"&Occult":"神秘(&O)",
	"&Speech Recognition":"语音识别(&S)",
	"&Vertical Color Box":"纵向颜色框(&V)",
	"Manage Storage":"管理存储",
	"Project News":"项目新闻",
	"Donate":"捐赠",
	"&Load From URL":"从链接导入(&L)",
	"&Upload To Imgur":"上传到Imgur(&U)",
	"Opens an image from the web.":"打开网上图片。",
	"Uploads the active document to Imgur":"将当前文档上传到Imgur。",
	"Manages storage of previously created or opened pictures.":"管理之前创建与打开的图片的存储空间。",
	"Tiles this bitmap as the desktop background.":"将该位图作为桌面墙纸平铺显示。",
	"Centers this bitmap as the desktop background.":"将该位图作为桌面墙纸居中显示。",
	"Shows the document history and lets you navigate to states not accessible with Undo or Repeat.":"显示文档的操作历史记录以便撤消或重复。",
	"Creates an animation from the document history.":"从文档的操作历史记录创建动画。",
	"Starts a new multi-user session from the current document.":"从当前文档新建多人协作会话。",
	"Starts a new multi-user session from an empty document.":"从空白文档新建多人协作会话。",
	"Changes the language to %1.":"将语言改为 %1。",
	"Controls the application with voice commands.":"用语音命令控制应用。",
	"Arranges the color box vertically.":"纵向排列颜色框。",
	"Shows news about JS Paint.":"显示关于 JS Paint 的新闻",
	"Shows the project on GitHub.":"在 Github 上显示本项目",
	"Supports the project.":"支持本项目",
	"Zoom To &Window":"适应窗口(&W)",
	"Zooms the picture to fit within the view.":"缩放图片，使其在窗口中完全显示。",
	"Displays information about this application.":"显示关于本应用的信息。"
});
