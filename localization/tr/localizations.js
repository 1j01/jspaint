...
loaded_localizations("tr", {
	...
	"&Pixel Grid": "&Piksel Kılavuzu",
	"Pixel Grid": "Piksel Kılavuzu",
	"&Tile Grid": "Kılavu&z Döşe",
	"Tile Grid": "Kılavuz Döşe",
	"pixels": "piksel",
	"H&eight:": "&Yükseklik:",
	"Text": "Metin",
	"Undo": "Geri Al",
	...
	"C&ustom": "Ö&zel",
	"Custom": "Özel",
	"Show &Grid": "Kılavuzu Gö&ster",
	"Show Grid": "Kılavuzu Göster",
	...
	"The grid spacing must be an integer between %d and %d.": "Kılavuz aralığı, %d ile %d arasında bir tamsayı olmalıdır.",
	...
	"Shows or hides the grid.": "Kılavuzu gösterir veya gizler.",
