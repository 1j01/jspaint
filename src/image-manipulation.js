...
// window.copy_contents_within_polygon = copy_contents_within_polygon; // unused
// window.draw_bezier_curve = draw_bezier_curve; // unused
// window.draw_bezier_curve_without_pattern_support = draw_bezier_curve_without_pattern_support; // unused
// window.draw_ellipse = draw_ellipse; // unused
// window.draw_fill = draw_fill; // unused
// window.draw_fill_separately = draw_fill_separately; // unused
// window.draw_fill_without_pattern_support = draw_fill_without_pattern_support; // unused
// window.draw_grid = draw_grid; // unused
// window.draw_line = draw_line; // unused
// window.draw_line_strip = draw_line_strip; // unused
// window.draw_line_without_pattern_support = draw_line_without_pattern_support; // unused
// window.draw_noncontiguous_fill = draw_noncontiguous_fill; // unused
// window.draw_noncontiguous_fill_separately = draw_noncontiguous_fill_separately; // unused
// window.draw_noncontiguous_fill_without_pattern_support = draw_noncontiguous_fill_without_pattern_support; // unused
// window.draw_polygon = draw_polygon; // unused
// window.draw_quadratic_curve = draw_quadratic_curve; // unused
// window.draw_rounded_rectangle = draw_rounded_rectangle; // unused
// window.draw_selection_box = draw_selection_box; // unused
// window.draw_with_swatch = draw_with_swatch; // unused
// window.find_color_globally = find_color_globally; // unused
// window.flip_horizontal = flip_horizontal; // unused
// window.flip_vertical = flip_vertical; // unused
// window.get_brush_canvas_size = get_brush_canvas_size; // unused
// window.get_circumference_points_for_brush = get_circumference_points_for_brush; // unused
// window.invert_monochrome = invert_monochrome; // unused
// window.invert_rgb = invert_rgb; // unused
// window.render_brush = render_brush; // unused
// window.replace_color_globally = replace_color_globally; // unused
// window.replace_colors_with_swatch = replace_colors_with_swatch; // unused
// window.rotate = rotate; // unused
// window.stamp_brush_canvas = stamp_brush_canvas; // unused
// window.stretch_and_skew = stretch_and_skew; // unused
// window.threshold_black_and_white = threshold_black_and_white; // unused
// window.update_brush_for_drawing_lines = update_brush_for_drawing_lines; // unused
