...
function show_news() {
	...
	$news_window.on("closed", () => {
		$news_window = null;
		change_url_param("project-news", false);
	});
	change_url_param("project-news", true);
