...
// window.get_all_url_params = get_all_url_params; // unused
// window.get_url_param = get_url_param; // unused
// window.change_url_param = change_url_param; // unused
window.change_some_url_params = change_some_url_params; // may be used by menus.js
// window.set_all_url_params = set_all_url_params; // unused
// window.update_magnified_canvas_size = update_magnified_canvas_size; // unused
// window.update_canvas_rect = update_canvas_rect; // unused
window.update_helper_layer = update_helper_layer; // may be used by app-state.js
// window.update_helper_layer_immediately = update_helper_layer_immediately; // unused
// window.render_canvas_view = render_canvas_view; // unused
// window.update_disable_aa = update_disable_aa; // unused
// window.set_magnification = set_magnification; // unused
// window.show_custom_zoom_window = show_custom_zoom_window; // unused
// window.toggle_grid = toggle_grid; // unused
// window.toggle_thumbnail = toggle_thumbnail; // unused
// window.reset_selected_colors = reset_selected_colors; // unused
// window.reset_file = reset_file; // unused
// window.reset_canvas_and_history = reset_canvas_and_history; // unused
window.make_history_node = make_history_node; // may be used by app-state.js
// window.update_title = update_title; // unused
// window.get_uris = get_uris; // unused
window.load_image_from_uri = load_image_from_uri; // may be used by helpers.js
// window.open_from_image_info = open_from_image_info; // unused
window.open_from_file = open_from_file; // may be used by electron-injected.js
// window.apply_file_format_and_palette_info = apply_file_format_and_palette_info; // unused
// window.load_theme_from_text = load_theme_from_text; // unused
// window.file_new = file_new; // unused
// window.file_open = file_open; // unused
// window.file_load_from_url = file_load_from_url; // unused
// window.confirm_overwrite_capability = confirm_overwrite_capability; // unused
// window.file_save = file_save; // unused
// window.file_save_as = file_save_as; // unused
window.are_you_sure = are_you_sure; // may be used by app-localization.js, app.js, electron-injected.js, electron-main.js
// window.please_enter_a_number = please_enter_a_number; // unused
window.show_error_message = show_error_message; // may be used by app-localization.js, electron-injected.js, imgur.js
// window.show_resource_load_error_message = show_resource_load_error_message; // unused
// window.show_file_format_errors = show_file_format_errors; // unused
...
// window.update_css_classes_for_conditional_messages = update_css_classes_for_conditional_messages; // unused
// window.show_news = show_news; // unused
// window.paste_image_from_file = paste_image_from_file; // unused
// window.choose_file_to_paste = choose_file_to_paste; // unused
window.paste = paste; // may be used by copy-inkscape-labels.js, electron-main.js, extra-tools.js, help.js, repack-spritesheet.js
// window.render_history_as_gif = render_history_as_gif; // unused
// window.go_to_history_node = go_to_history_node; // unused
window.undoable = undoable; // may be used by OnCanvasTextBox.js
// window.make_or_update_undoable = make_or_update_undoable; // unused
...
// window.get_history_ancestors = get_history_ancestors; // unused
// window.show_document_history = show_document_history; // unused
...
// window.meld_selection_into_canvas = meld_selection_into_canvas; // unused
// window.meld_textbox_into_canvas = meld_textbox_into_canvas; // unused
window.deselect = deselect; // may be used by $ToolBox.js
// window.delete_selection = delete_selection; // unused
// window.select_all = select_all; // unused
// window.try_exec_command = try_exec_command; // unused
// window.getSelectionText = getSelectionText; // unused
// window.edit_copy = edit_copy; // unused
// window.edit_cut = edit_cut; // unused
// window.edit_paste = edit_paste; // unused
// window.image_invert_colors = image_invert_colors; // unused
...
// window.view_bitmap = view_bitmap; // unused
window.get_tool_by_id = get_tool_by_id; // may be used by app-state.js
// window.select_tools = select_tools; // unused
// window.select_tool = select_tool; // unused
window.has_any_transparency = has_any_transparency; // may be used by sessions.js
// window.detect_monochrome = detect_monochrome; // unused
// window.make_monochrome_pattern = make_monochrome_pattern; // unused
window.make_monochrome_palette = make_monochrome_palette; // may be used by app-state.js
// window.make_stripe_pattern = make_stripe_pattern; // unused
// window.switch_to_polychrome_palette = switch_to_polychrome_palette; // unused
// window.make_opaque = make_opaque; // unused
// window.resize_canvas_without_saving_dimensions = resize_canvas_without_saving_dimensions; // unused
// window.resize_canvas_and_save_dimensions = resize_canvas_and_save_dimensions; // unused
// window.image_attributes = image_attributes; // unused
// window.show_convert_to_black_and_white = show_convert_to_black_and_white; // unused
// window.image_flip_and_rotate = image_flip_and_rotate; // unused
// window.image_stretch_and_skew = image_stretch_and_skew; // unused
// window.handle_keyshortcuts = handle_keyshortcuts; // unused
// window.save_as_prompt = save_as_prompt; // unused
// window.write_image_file = write_image_file; // unused
// window.read_image_file = read_image_file; // unused
// window.update_from_saved_file = update_from_saved_file; // unused
// window.save_selection_to_file = save_selection_to_file; // unused
window.sanity_check_blob = sanity_check_blob; // may be used by electron-injected.js
// window.show_multi_user_setup_dialog = show_multi_user_setup_dialog; // unused
// window.cleanup_bitmap_view = cleanup_bitmap_view; // unused
// window.$this_version_news = $this_version_news; // unused
