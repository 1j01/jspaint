...
import { drawEllipse, drawRectangle, drawRoundedRectangle, getShapeColors } from "../utils/drawingUtils";
...
// Shape tool IDs
const SHAPE_TOOLS: readonly ToolId[] = [
  TOOL_IDS.LINE,
  TOOL_IDS.RECTANGLE,
  TOOL_IDS.ELLIPSE,
    ...
    (x: number, y: number, toolId: ToolId, ctx: CanvasRenderingContext2D, shiftKey = false): void => {
      ...
      switch (toolId) {
        ...
        case TOOL_IDS.ROUNDED_RECTANGLE:
          drawRoundedRectangle(ctx, startX, startY, width, height, shapeStrokeColor, shapeFillColor, strokeWidth);
          break;
      }
