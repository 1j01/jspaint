...
export {
	available_languages, display_hotkey, get_hotkey, get_iso_language_name, get_language, get_language_emoji, get_language_endonym, localize
};
// Temporary globals until all dependent code is converted to ES Modules
window.localize = localize;
window.set_language = set_language;
window.get_language = get_language;
window.get_iso_language_name = get_iso_language_name;
window.get_language_endonym = get_language_endonym;
window.get_language_emoji = get_language_emoji;
window.get_direction = get_direction;
window.available_languages = available_languages;

// @TODO: these should come from os-gui.js (new AccessKeys API)
export { get_direction, remove_hotkey, set_language };
// Temporary globals until all dependent code is converted to ES Modules
window.remove_hotkey = remove_hotkey;
window.display_hotkey = display_hotkey;
window.get_hotkey = get_hotkey;
