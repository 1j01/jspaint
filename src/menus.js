...
/* global $canvas_area, $colorbox, $status_area, $toolbox, change_url_param, choose_file_to_paste, clear, delete_selection, deselect, edit_copy, edit_cut, edit_paste, file_load_from_url, file_new, file_open, file_save, file_save_as, image_attributes, image_flip_and_rotate, image_invert_colors, image_stretch_and_skew, magnification, main_canvas, menu_bar, MENU_DIVIDER, palette_formats, redo, redos, render_history_as_gif, sanity_check_blob, save_selection_to_file, select_all, selection, set_magnification, show_about_paint, show_custom_zoom_window, show_document_history, show_edit_colors_window, show_file_format_errors, show_grid, show_imgur_uploader, show_multi_user_setup_dialog, show_news, show_thumbnail, systemHooks, toggle_grid, toggle_thumbnail, undo, undos, view_bitmap */
